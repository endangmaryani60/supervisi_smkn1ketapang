...
import { BookOpen, Calendar, CheckCircle2, Target, ShieldCheck, Printer, Search, Filter } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { triggerPrint } from '../../utils/printHelper';
import { Pagination } from '../common/Pagination';

export const SupervisionProgram: React.FC = () => {
  const { schoolSettings, teachers, setActiveTab, setSelectedTeacherId } = useAuth();
      ...
      <div id="program-document-card" className="space-y-6">
        ...
        <div className="hidden print:block text-center border-b-2 border-slate-900 pb-4 space-y-1">
          ...
          <p className="text-[11px] font-semibold text-slate-500">
            DOKUMEN PROGRAM DOKUMEN SUPERVISI AKADEMIK (SI SUPAK) — TP {schoolSettings.academicYear} SEMESTER {schoolSettings.semester.toUpperCase()}
          </p>
        </div>
                      ...
                      return (
                        <tr key={teacher.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="py-3 px-3 border-r border-slate-200">
                            ...
                            <div className="text-[11px] text-gray-500">NIP: {teacher.nip || '-'}</div>
                          </td>
