        ...
        >
          ...
          <div className="text-center border-b-2 border-slate-900 pb-4 space-y-1">
            ...
            <p className="text-[11px] font-semibold text-slate-500">
              LAPORAN HASIL SUPERVISI AKADEMIK (SI SUPAK) — TP {schoolSettings.academicYear} SEMESTER {schoolSettings.semester.toUpperCase()}
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-slate-500">Nomor Berkas: SUPAK/{schoolSettings.academicYear.replace('/', '')}/{currentTeacher.id.toUpperCase()}</p>
          </div>
          ...
          <div className="flex items-center justify-between rounded-xl bg-indigo-50 border border-indigo-100 p-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <div className="text-3xl font-black text-indigo-950">{session.finalScore || 85}</div>
                <div className="text-[10px] text-indigo-700 uppercase font-bold">Skala 100</div>
              </div>
              <span className="rounded-xl bg-indigo-700 px-3.5 py-1.5 text-xs font-extrabold text-white shadow-sm">
                {session.finalPredicate || 'Baik'}
              </span>
            </div>
          </div>
                  ...
                  return (
                    <tr key={t.id} className="hover:bg-slate-50">
                      ...
                      <td className="py-2.5 px-3 border-r border-slate-200">
                        ...
                        <div className="text-[10px] text-slate-500">NIP: {t.nip || '-'}</div>
                      </td>
                      ...
                      <td className="py-2.5 px-3 border-r border-slate-200 text-center font-black text-slate-900">{s?.finalScore || 85}</td>
                      <td className="py-2.5 px-3 border-r border-slate-200 text-center font-bold text-indigo-900">{s?.finalPredicate || 'Baik'}</td>
