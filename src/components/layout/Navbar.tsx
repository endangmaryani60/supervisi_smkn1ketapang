  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-gray-200 bg-white/95 px-3 md:px-8 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1A1A1A] text-white shadow-sm shrink-0">
          <School className="h-5 w-5 text-white" />
        </div>
        <div>
          <div className="flex items-center gap-2">
            <span className="serif-display font-bold tracking-tight text-slate-900 text-sm md:text-lg">SI SUPER</span>
