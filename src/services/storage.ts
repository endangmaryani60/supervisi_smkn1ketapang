...
const KEYS = {
  SETTINGS: 'sisuper_school_settings_v10',
  ACCOUNTS: 'sisuper_user_accounts_v10',
  TEACHERS: 'sisuper_teachers_v10',
  SESSIONS: 'sisuper_supervision_sessions_v10',
  CURRENT_USER: 'sisuper_session_user_v10',
};
...
// Official dataset of 93 teachers synchronized with Rekap Supervisi dan Observasi Kinerja Guru Genap 2025/2026
export const RAW_TEACHERS_DATA = [
  ...
  { no: 2, name: 'M. Ajon, S.Pd', nip: '19700110 199702 1 003', username: 'majon', subject: 'Bahasa Inggris', className: 'X TKJ 1 / XII TKJ 1', pangkatGolongan: 'Pembina, IV/a (Guru Madya)', supervisorName: '', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Belum' as const },
  { no: 3, name: 'Irawan, S.Pd', nip: '19700419 200003 1 003', username: 'irawan', subject: 'Dasar Program Keahlian AKL', className: 'XI AKL 1', pangkatGolongan: 'Pembina, IV/a (Guru Madya)', supervisorName: 'Rosilawati, S.Pd', obsDate: '2026-03-05', praDate: '2026-03-02', pascaDate: '2026-03-08', status: 'Selesai' as const },
  ...
  { no: 7, name: 'Suryati, S.Pd', nip: '19770906 200212 2 004', username: 'suryati', subject: 'Matematika', className: 'XII TKJ 1 / XI BisDig 2', pangkatGolongan: 'Pembina, IV/a (Guru Madya)', supervisorName: 'Wiwin Wulandari, SE', obsDate: '2026-02-13', praDate: '2026-02-10', pascaDate: '2026-02-16', status: 'Selesai' as const },
  { no: 8, name: 'Hery Gunawan, S.Kom', nip: '19770426 200604 1 007', username: 'herygunawan', subject: 'Informatika & KKA', className: 'XI TKJ 1', pangkatGolongan: 'Pembina, IV/a (Guru Madya)', supervisorName: '', obsDate: '2026-03-09', praDate: '2026-03-06', pascaDate: '2026-03-12', status: 'Belum' as const },
  ...
  { no: 11, name: 'Wiwin Wulandari, SE', nip: '19751213 200701 2 018', username: 'wiwinwulandari', subject: 'Bisnis Digital', className: 'XII AKL 1', pangkatGolongan: 'Penata Tk.I, III/d (Guru Muda)', supervisorName: 'Endang Maryani, S.Pd', obsDate: '2026-02-27', praDate: '2026-02-24', pascaDate: '2026-03-02', status: 'Selesai' as const },
  { no: 12, name: 'Sumanti, S.Pd', nip: '19760601 200604 2 034', username: 'sumanti', subject: 'Pelayanan BK/BP', className: 'X TKR 1', pangkatGolongan: 'Penata Tk.I, III/d (Guru Muda)', supervisorName: 'Yulia Hartati, S.Pd', obsDate: '2026-02-26', praDate: '2026-02-23', pascaDate: '2026-03-01', status: 'Selesai' as const },
  { no: 13, name: 'Sumiyatun, S.Pd.Ing', nip: '19660802 199203 2 006', username: 'sumiyatun', subject: 'Bahasa Inggris', className: 'XI BisDig 1', pangkatGolongan: 'Penata Tk.I, III/d (Guru Muda)', supervisorName: '', obsDate: '2026-03-09', praDate: '2026-03-06', pascaDate: '2026-03-12', status: 'Belum' as const },
  { no: 14, name: 'Endang Maryani, S.Pd', nip: '19861016 201001 2 013', username: 'endangmaryani', subject: 'Projek IPAS (Waka Kurikulum)', className: 'X Keperawatan', pangkatGolongan: 'Penata Tk.I, III/d (Guru Muda)', supervisorName: 'Vida Nourmalita, S.Pd', obsDate: '2026-03-11', praDate: '2026-03-08', pascaDate: '2026-03-14', status: 'Selesai' as const },
  { no: 15, name: 'Henny Mufizawati, S.Pd', nip: '19840127 200903 2 003', username: 'hennymufizawati', subject: 'Pendidikan Pancasila', className: 'XII BisDig 2', pangkatGolongan: 'Penata Tk.I, III/d (Guru Muda)', supervisorName: 'Endang Maryani, S.Pd', obsDate: '2026-02-26', praDate: '2026-02-23', pascaDate: '2026-03-01', status: 'Selesai' as const },
  ...
  { no: 17, name: 'Arie Sumartini, ST', nip: '19800315 200604 2 013', username: 'ariesumartini', subject: 'Teknik Komputer & Jaringan', className: 'XI TKJ', pangkatGolongan: 'Penata, III/c (Guru Muda)', supervisorName: '', obsDate: '2026-02-26', praDate: '2026-02-23', pascaDate: '2026-03-01', status: 'Belum' as const },
  ...
  { no: 20, name: 'Syarifudin, S.Pd., M.B.A', nip: '19850622 200903 1 001', username: 'syarifudin', subject: 'Bahasa Inggris (Waka Humastri)', className: 'XII BisDig 2', pangkatGolongan: 'Penata, III/c (Guru Muda)', supervisorName: 'Vida Nourmalita, S.Pd', obsDate: '2026-03-09', praDate: '2026-03-06', pascaDate: '2026-03-12', status: 'Selesai' as const },
  ...
  { no: 22, name: 'Syahranuddin Fadli, S.ST.Par', nip: '19840628 201001 1 011', username: 'syahranuddinfadli', subject: 'Perhotelan & Kuliner', className: 'XII PH 1', pangkatGolongan: 'Penata, III/c (Guru Muda)', supervisorName: '', obsDate: '2026-02-10', praDate: '2026-02-07', pascaDate: '2026-02-13', status: 'Belum' as const },
  ...
  { no: 26, name: 'Vida Nourmalita, S.Pd', nip: '19870107 201001 2 003', username: 'vidanourmalita', subject: 'Bahasa Inggris (Waka Mutu)', className: 'X TKJ 2', pangkatGolongan: 'Penata Muda Tk.I, III/b (Guru Pertama)', supervisorName: 'Syarifudin, S.Pd., M.B.A', obsDate: '2026-03-04', praDate: '2026-03-01', pascaDate: '2026-03-07', status: 'Selesai' as const },
  { no: 27, name: 'Pratiwi, S.Pd', nip: '19860430 200903 2 007', username: 'pratiwi1', subject: 'Matematika & Informatika', className: 'XI TKJ & DKV', pangkatGolongan: 'Penata Muda Tk.I, III/b (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-09', praDate: '2026-02-06', pascaDate: '2026-02-12', status: 'Selesai' as const },
  { no: 28, name: 'Rotua Silaen, S.Pd', nip: '19730213 200701 2 010', username: 'rotuasilaen', subject: 'Manajemen Perkantoran', className: 'XII MP 2', pangkatGolongan: 'Penata Muda, III/a (Guru Pertama)', supervisorName: 'Endang Maryani, S.Pd', obsDate: '2026-03-09', praDate: '2026-03-06', pascaDate: '2026-03-12', status: 'Selesai' as const },
  { no: 29, name: 'Roci Anggraini, S.Kep., Ns', nip: '19900416 202221 2 022', username: 'rocianggraini', subject: 'Layanan Kesehatan', className: 'XI KPR 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Vida Nourmalita, S.Pd', obsDate: '2026-03-30', praDate: '2026-03-27', pascaDate: '2026-04-02', status: 'Selesai' as const },
  ...
  { no: 32, name: 'Andri Cahyadi, S.Tr.Par', nip: '19740205 202321 1 004', username: 'andricahyadi', subject: 'FB Service', className: 'XI PH 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Yana Apriliya, S.ST.Par', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  { no: 33, name: 'Ani Budiarti, S.Pd', nip: '19870401 202321 2 029', username: 'anibudiarti', subject: 'Matematika', className: 'XI LP3K', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Syahranuddin Fadli, S.ST.Par', obsDate: '2026-03-31', praDate: '2026-03-28', pascaDate: '2026-04-03', status: 'Selesai' as const },
  ...
  { no: 37, name: 'Mahbub Susanto, S.Sos', nip: '19810813 202321 1 003', username: 'mahbubsusanto', subject: 'Manajemen Perkantoran', className: 'X MP 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 38, name: 'Yohanes Belmi Lesmana Putra, S.Pd', nip: '19911009 202321 1 013', username: 'yohanesbelmilesmanaputra', subject: 'Matematika', className: 'XII TKJ 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-02-26', praDate: '2026-02-23', pascaDate: '2026-03-01', status: 'Belum' as const },
  { no: 39, name: 'Riana Br. Karo, S.Pd', nip: '19810918 202321 2 010', username: 'rianabrkaro', subject: 'Dasar Program Keahlian Pemasaran', className: 'X BisDig 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Wiwin Wulandari, SE', obsDate: '2026-02-23', praDate: '2026-02-20', pascaDate: '2026-02-26', status: 'Selesai' as const },
  ...
  { no: 41, name: 'Pratiwi, S.Pd', nip: '19880906 202421 2 032', username: 'pratiwi2', subject: 'Bahasa Inggris', className: 'XI ULW', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Suryatina, SE', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  ...
  { no: 43, name: 'Siti Aisyah Ulumando, S.Pd', nip: '19880625 202421 2 028', username: 'sitiaisyahulumando', subject: 'Matematika', className: 'XI MP 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 44, name: 'Sumaryati, S.Pd', nip: '19880907 202421 2 037', username: 'sumaryati', subject: 'Bahasa Inggris', className: 'X ULW', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Suryatina, SE', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  ...
  { no: 47, name: 'Perliandi, S.Pd', nip: '19870106 202421 1 010', username: 'perliandi', subject: 'Bahasa Indonesia', className: 'X AK 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Vida Nourmalita, S.Pd', obsDate: '2026-03-06', praDate: '2026-03-03', pascaDate: '2026-03-09', status: 'Selesai' as const },
  ...
  { no: 50, name: 'Hella Cristi, S.Pd', nip: '19900804 202421 2 027', username: 'hellacristi', subject: 'Bahasa Indonesia', className: 'XI MP 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-03-10', praDate: '2026-03-07', pascaDate: '2026-03-13', status: 'Selesai' as const },
  { no: 51, name: 'Mutiah Wijayanti, S.Pd', nip: '19900322 202421 2 029', username: 'mutiahwijayanti', subject: 'Bahasa Inggris', className: 'X BisDig 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Belum' as const },
  { no: 52, name: 'Tika Sayyidah Sofia, S.Pd', nip: '19961010 202421 2 058', username: 'tikasayyidahsofia', subject: 'Matematika', className: 'X LPB', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Erini, SP, M.MPd', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Belum' as const },
  { no: 53, name: 'M. Aliyul Qurri, SH, M.Pd', nip: '19940706 202421 1 020', username: 'maliyulqurri', subject: 'Pendidikan Agama Islam', className: 'XII BisDig 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Rochmad Basuki, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 54, name: 'Eko Kurniawan, S.Pd', nip: '19941216 202421 1 016', username: 'ekokurniawan', subject: 'Dasar Program Keahlian DKV', className: 'XI DKV 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Pratiwi, S.Pd', obsDate: '2026-03-11', praDate: '2026-03-08', pascaDate: '2026-03-14', status: 'Selesai' as const },
  { no: 55, name: 'Endang Dewi Lestari, S.Tr.Kep', nip: '19960719 202421 2 033', username: 'endangdewilestari', subject: 'Projek IPAS & Keperawatan', className: 'XI LPKC 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Roci Anggraini, S.Kep., Ns', obsDate: '2026-03-30', praDate: '2026-03-27', pascaDate: '2026-04-02', status: 'Selesai' as const },
  { no: 56, name: 'Ali Nukarta, M.Pd', nip: '19911102 202421 1 019', username: 'alinukarta', subject: 'Bahasa Indonesia', className: 'X AK 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-03-10', praDate: '2026-03-07', pascaDate: '2026-03-13', status: 'Belum' as const },
  { no: 57, name: 'Dian Purnama Rizki, S.Pd', nip: '19961126 202421 2 033', username: 'dianpurnamar', subject: 'Informatika & Kewirausahaan', className: 'XII DKV 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Pratiwi, S.Pd', obsDate: '2026-03-11', praDate: '2026-03-08', pascaDate: '2026-03-14', status: 'Selesai' as const },
  ...
  { no: 59, name: 'Syahri Erpandi, S.Pd', nip: '19930317 202421 1 022', username: 'syahrierpandi', subject: 'Design Brief & Grafika', className: 'XI DKV 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Pratiwi, S.Pd', obsDate: '2026-03-11', praDate: '2026-03-08', pascaDate: '2026-03-14', status: 'Selesai' as const },
  ...
  { no: 61, name: 'Yuli Prihardiyono, S.IP', nip: '19950730 202421 1 012', username: 'yuliprihardiyono', subject: 'Manajemen Perkantoran', className: 'XI OTKP', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 62, name: 'Weldani, S.Pd.I', nip: '19860301 202421 1 018', username: 'weldani', subject: 'Pendidikan Agama Islam', className: 'X TKR 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-03-31', praDate: '2026-03-28', pascaDate: '2026-04-03', status: 'Belum' as const },
  { no: 63, name: 'Ridho Pratama, S.Pd', nip: '19981015 202421 1 007', username: 'ridhopratama', subject: 'Konsentrasi Keahlian Kuliner', className: 'X KUL', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Syahranuddin Fadli, S.ST.Par', obsDate: '2026-03-30', praDate: '2026-03-27', pascaDate: '2026-04-02', status: 'Selesai' as const },
  { no: 64, name: 'Esti Kholisa Hasanah, S.Pd', nip: '20000622 202421 2 007', username: 'estikholisahasanah', subject: 'Bahasa Indonesia', className: 'X PH 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Erini, SP, M.MPd', obsDate: '2026-03-05', praDate: '2026-03-02', pascaDate: '2026-03-08', status: 'Belum' as const },
  ...
  { no: 66, name: 'Putri Sholehah Hasanah, S.Pd', nip: '20000622 202421 2 010', username: 'putrisholehahhasanah', subject: 'Matematika', className: 'XII LPKC', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Roci Anggraini, S.Kep., Ns', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  { no: 67, name: 'Sapuan Noor, S.Pd', nip: '19871201 202421 1 015', username: 'sapuannoor', subject: 'Bahasa Inggris', className: 'XII MP 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-02-11', praDate: '2026-02-08', pascaDate: '2026-02-14', status: 'Belum' as const },
  ...
  { no: 74, name: 'Genoveva Sonia, S.Pd', nip: '19990511 202421 2 025', username: 'genovevasonia', subject: 'Pemasaran & Bisnis Digital', className: 'XII BisDig 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Wiwin Wulandari, SE', obsDate: '2026-02-25', praDate: '2026-02-22', pascaDate: '2026-02-28', status: 'Selesai' as const },
  ...
  { no: 76, name: 'Novi Wahyuni, S.Pd', nip: '19920816 202521 2 047', username: 'noviwahyuni', subject: 'Bisnis Digital & Mandarin', className: 'XI TKR 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Suryatina, SE', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  ...
  { no: 78, name: 'Sudjinartining, S.Pd', nip: '19720112 202221 2 004', username: 'sudjinartining', subject: 'Manajemen Perkantoran', className: 'X MP 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 79, name: 'Ramadhia Putri Utami, S.Tr.Keb', nip: '19960209 202521 2 035', username: 'ramadhiaputriutami', subject: 'Layanan Keperawatan', className: 'X LPKC 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Roci Anggraini, S.Kep., Ns', obsDate: '2026-03-03', praDate: '2026-02-28', pascaDate: '2026-03-06', status: 'Selesai' as const },
  { no: 80, name: 'Suci Adelia Putri, S.Pd', nip: '19991210 202521 2 020', username: 'suciadeliaputri', subject: 'Seni Budaya', className: 'X PH', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Yana Apriliya, S.ST.Par', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  { no: 81, name: 'Hasiholan Sitompul, S.Pd.K', nip: '-', username: 'hasiholansitompul', subject: 'Pendidikan Agama Kristen', className: 'X-XII Agama Kristen', pangkatGolongan: 'Pembina, IV/a (Guru Madya)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 82, name: 'Bong Sin Sang', nip: '-', username: 'bongsinsang', subject: 'Pendidikan Agama / Bahasa Mandarin', className: 'X PH 1', pangkatGolongan: 'Penata, III/c (Guru Muda)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 83, name: 'Andriansen Hartanto', nip: '-', username: 'andriansenhartanto', subject: 'Pendidikan Agama / TKJ', className: 'X TKJ 2', pangkatGolongan: 'Penata Muda Tk.I, III/b (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 84, name: 'Fransiska Siki, S.Pd', nip: '-', username: 'fransiskasaki', subject: 'Pendidikan Agama / Seni Rupa', className: 'X DKV 1', pangkatGolongan: 'Penata Muda, III/a (Guru Pertama)', supervisorName: 'Ela Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 85, name: 'Nurul Ridhi Utami, S.Pd., M.Pd', nip: '-', username: 'nurulridhiutami', subject: 'K3 & Kuliner', className: 'XII KUL', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-02-09', praDate: '2026-02-06', pascaDate: '2026-02-12', status: 'Belum' as const },
  { no: 86, name: 'apt. Farhanisa, S.Farm', nip: '-', username: 'farhanisa', subject: 'Layanan Kefarmasian', className: 'X LPK3', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: '', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Belum' as const },
  { no: 87, name: 'Indah Oemardi Putri, S.Par., CGSP', nip: '-', username: 'indahoemardiputri', subject: 'Usaha Layanan Wisata', className: 'XII ULW', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Suryatina, SE', obsDate: '2026-02-11', praDate: '2026-02-08', pascaDate: '2026-02-14', status: 'Selesai' as const },
  { no: 88, name: 'Cindy Anggraini, S.Pd', nip: '-', username: 'cindyanggraini', subject: 'Bahasa Indonesia', className: 'XI BisDig 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Wiwin Wulandari, SE', obsDate: '2026-02-09', praDate: '2026-02-06', pascaDate: '2026-02-12', status: 'Selesai' as const },
  { no: 89, name: 'Neneng Gustiana, S.Pd', nip: '-', username: 'nenenggustiana', subject: 'Sejarah', className: 'XII TKJ 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Yana Apriliya, S.ST.Par', obsDate: '2026-02-25', praDate: '2026-02-22', pascaDate: '2026-02-28', status: 'Selesai' as const },
  { no: 90, name: 'Jelisti Utami, S.Pd', nip: '-', username: 'jelistiutami', subject: 'Pelayanan BK/BP', className: 'XI TSM 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Sumanti, S.Pd', obsDate: '2026-02-23', praDate: '2026-02-20', pascaDate: '2026-02-26', status: 'Selesai' as const },
  { no: 91, name: 'Arliana, S.Km', nip: '-', username: 'arliana', subject: 'Projek IPAS', className: 'X LPKC 2', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Roci Anggraini, S.Kep., Ns', obsDate: '2026-03-02', praDate: '2026-02-27', pascaDate: '2026-03-05', status: 'Selesai' as const },
  { no: 92, name: 'Supriyadi Sofian, S.E', nip: '-', username: 'supriyadisofian', subject: 'Kewirausahaan & Management', className: 'XII AKL 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Ella Susiani, S.Pd', obsDate: '2026-02-24', praDate: '2026-02-21', pascaDate: '2026-02-27', status: 'Selesai' as const },
  { no: 93, name: 'Yoni Darmansyah, ST', nip: '-', username: 'yonidarmansyah', subject: 'Dasar Program Keahlian TJKT', className: 'XI TITL 1', pangkatGolongan: 'Golongan IX (Guru Pertama)', supervisorName: 'Arie Sumartini, ST', obsDate: '2026-02-11', praDate: '2026-02-08', pascaDate: '2026-02-14', status: 'Selesai' as const },
];

// Update username in RAW_TEACHERS_DATA: use NIP without spaces if available, or full name without spaces if no NIP
RAW_TEACHERS_DATA.forEach((t) => {
  const cleanNip = t.nip ? t.nip.replace(/\s+/g, '').trim() : '';
  if (cleanNip && cleanNip !== '-') {
    t.username = cleanNip;
  } else {
    t.username = t.name.replace(/\s+/g, '').toLowerCase();
  }
});
...
export function getAccountsSync(): UserAccount[] {
  ...
  try {
    ...
    parsed.forEach((acc) => {
      if (acc.id !== 'acc-admin') {
        const cleanNip = acc.nip ? acc.nip.replace(/\s+/g, '').trim() : '';
        const expectedUsername = (cleanNip && cleanNip !== '-') 
          ? cleanNip 
          : (acc.name ? acc.name.replace(/\s+/g, '').toLowerCase() : acc.username);
    ...
    if (modified) {
      localStorage.setItem(KEYS.ACCOUNTS, JSON.stringify(parsed));
    }
    return parsed;
  } catch {
    return [];
...
export function getSessions(): Record<string, SupervisionSession> {
  ...
  try {
    const parsed: Record<string, SupervisionSession> = JSON.parse(data);
    let modified = false;
    Object.keys(parsed).forEach((key) => {
      if (parsed[key].finalScore !== undefined || parsed[key].finalPredicate !== undefined) {
        delete parsed[key].finalScore;
        delete parsed[key].finalPredicate;
        modified = true;
      }
    });
    if (modified) {
      localStorage.setItem(KEYS.SESSIONS, JSON.stringify(parsed));
    }
    return parsed;
  } catch {
    return {};
